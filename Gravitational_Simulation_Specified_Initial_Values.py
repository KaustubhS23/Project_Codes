...
def initialize_particles(n, x_pos, y_pos, z_pos, input_mass, velocity_x, velocity_y, velocity_z):
    vpython_spheres[n] = vp.sphere(pos=vp.vector(x_pos, y_pos, z_pos), velo=vp.vector(velocity_x, velocity_y, velocity_z), mass=input_mass, radius=radii, color=vp.color.white, make_trail=True)
